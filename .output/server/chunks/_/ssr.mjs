...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-CYZ5TE08.mjs');
...
const $$splitComponentImporter = () => import('./index-CmfpDtpp.mjs');
...
export { Route as R, serverEntry as default };
